...
/*
 * Verify the configuration file has all required values
 */
if (config.boards.length <= 0)
{
    console.log('ERROR: no boards set in config.js');
    process.exit(1);
}

if (config.admin_pw_file == 'undefined')
{
    console.log('ERROR: no admin_pw_file set in config.js');
    process.exit(1);
}
...
var secure_port = 443;
if (port != 80) secure_port = process.env.SECURE_PORT || 5443;
...
/*
 * Start the IRC server if configured
 */
