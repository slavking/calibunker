...
module.exports = function(req, callback) {
    ...
    console.log("cookie was ", req.cookies.password_livebunker);
    console.log("no limit is ", no_limit_cookie_string);

    if (req.cookies.password_livebunker == no_limit_cookie_string && no_limit_cookie_string !== '') {
        console.log("got a no limit request");
        return callback();
    }
    ...
    user_db
        ...
        .exec(function(e, d) {
            if (e || !d[0] || (req.cookies.password_livebunker !== d[0].session_key)) {
